...
<body>
  <div id="page">
    ...
    <div>
        <input style="border: 0px" id="panleft"></input>
        <input style="border: 0px" id="zoomin"></input>
        <input style="border: 0px" id="zoomout"></inpt>
        <input style="border: 0px" id="lasteight"></input>
        <input style="border: 0px" id="lasthour"></input>
        <input style="border: 0px" id="allof"></input>
        <input style="border: 0px" id="live"></input>
        <input style="border: 0px" id="fit"></input>
        <input style="border: 0px" id="panright"></input>
    </div>
    <div id="timelinediv">
...
foreach ($monitors as $m) {
  echo '<canvas width="' . $m->Width() * $defaultScale . 'px" height="'  . $m->Height() * $defaultScale . 'px" id="Monitor' . $m->Id() . '" style="border:3px solid blue" onclick="clickMonitor(event,' . $m->Id() . ')">No Canvas Support!!</canvas>';
}
?>
</div>
