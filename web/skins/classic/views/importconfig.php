...
if(isset($_POST["import"]))
{
 if($_FILES["database"]["name"] != '')
 {
  ...
  if($extension == 'sql')
  {
   ...
   {
    $message = '<label class="text-success">Config Successfully Imported</label>';
   }
  }
  else
  {
...
<html>
 <head>
  <title>Import Config From Backup</title>
 ...
 <body>
  ...
  <div class="container" style="width:400px;">
   <h2 align="center">Import ZoneMinder Config</h2>
   <br />
   <div><?php echo $message; ?></div>
   <form method="post" enctype="multipart/form-data">
    <p align="left"><label>Select Config File</label>
