...
if(isset($_POST["import"]))
{
 if($_FILES["database"]["name"] != '')
 {
  ...
  if($extension == 'sql')
  {
   ...
   {
    $message = '<label class="text-success">User Successfully Imported</label>';
   }
  }
  else
  {
...
<html>
 <head>
  <title>Import User From Backup</title>
 ...
 <body>
  ...
  <div class="container" style="width:400px;">
   <h2 align="center">Import ZoneMinder User</h2>
   <br />
   <div><?php echo $message; ?></div>
   <form method="post" enctype="multipart/form-data">
    <p align="left"><label>Select User File</label>
