<?php
xhtmlHeaders(__FILE__, translate('ExportUser') );
?>
<!DOCTYPE html>
 <html>
      <head>
           <title>Backup User ZoneMinder</title>
  ...
  <script type="text/javascript" src="skins/classic/views/js/monitorprobe.js"></script>
      ...
      <body>
           ...
           <div class="container" style="width:400px;">
                <h2 align="center">Backup User ZoneMinder</h2>
                <h3 align="center">Are you sure want to export all listed user to your computer?</h3>
                <br />
                <form method="post" action="skins/classic/views/exportuser.php" align="center">
